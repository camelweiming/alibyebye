...
public class Constants {
    ...
    public static final String SYSTEM_CONFIG_SPIDER_PROCESSOR = SYSTEM_CONFIG_PREFIX + "SPIDER_PROCESSOR";
    public static final String SYSTEM_CONFIG_SPIDER_SCHEDULE = SYSTEM_CONFIG_PREFIX + "SPIDER_SCHEDULE";
    public static final String SPIDER_DEFAULT_USER_AGENT = "Mozilla/5.0 (Linux; Android 6.0.1; Nexus 7 Build/MOB30X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36";
